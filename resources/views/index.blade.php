    ...
    <div class="container col-xxl-8 px-4 py-2">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            ...
            <div class="col-lg-6 text-center">
                ...
                <h1 class="display-5 fw-bold lh-1 mb-3">NMR8<br/>a'Gala Night</h1>
                <p class="lead">
...
{{--                    <div class="headline">2nd year</div>--}}
{{--                    <div class="description">2nd edition of GALA Night</div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--            <div class="col-12 col-sm-3 item">--}}
{{--                <div class="item-inner">--}}
{{--                    <div class="icon"><i class="icon-chat"></i></div>--}}
{{--                    <div class="headline">300 guests</div>--}}
{{--                    <div class="description">People from all over the world</div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--            <div class="col-12 col-sm-3 item">--}}
{{--                <div class="item-inner">--}}
{{--                    <div class="icon"><i class="icon-possibilities"></i></div>--}}
{{--                    <div class="headline">13 performers</div>--}}
...
{{--                    <div class="headline">10 raffle prizes</div>--}}
